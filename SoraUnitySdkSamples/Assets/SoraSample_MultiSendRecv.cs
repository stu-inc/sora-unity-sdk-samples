...
public class SoraSample_MultiSendRecv : MonoBehaviour
{
    ...
    public Sora.Role Role => Sora.Role.Sendrecv;
    ...
    IEnumerator Render()
    {
        while (true)
        {
            ...
            //     {
            //         using (var buf =
            //             new Unity.Collections.NativeArray<float>(samples * 2, Unity.Collections.Allocator.Temp))
            //         {
    ...
    void InitSora()
    {
        ...
        sora.OnNotify = (json) => { Debug.LogFormat("OnNotify: {0}", json); };
    ...
    public void OnClickStart()
    {
        ...
        var config = new Sora.Config()
        {
            ...
            UnityAudioInput = false,
            UnityAudioOutput = unityAudioOutput, // trueにしたい
